...
class Button {
    constructor(name, value, altValue, multiLang = false, inputType = true) {
        ...
        //
        this.domElement = create('BUTTON', 'keyboard__button button__'.concat(name.toLowerCase()), null, null, ['id', name]);
        this.spanForValue = create('SPAN', null, null, this.domElement);
        this.spanForShiftValue = create('SPAN', null, null, this.domElement);
        //
